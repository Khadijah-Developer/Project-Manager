const ProductController = require("../controllers/product.controller"); // import controllers
...
module.exports = app => {
  ...
  app.delete("/api/products/delete/:id", ProductController.deleteAnExistingProducts);
};